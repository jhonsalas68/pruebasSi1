...
@if(session('success'))
    ...
    <script>
        ...
        }, 5000); // Desaparece en 3 segundos
    </script>
@endif

<div class="flex justify-between items-center">
    <h1>Promotores</h1>
    <form action="{{ route('promotores.store') }}" , method="GET">
        <button type="submit"
...
@section('content')
<p>aqui solo se ven Promotores.</p>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 border-gray-200">
                ...
                <td class="px-6 py-4">
                    ...
                    <a href="#" data-modal-target="popup-modal" data-modal-toggle="popup-modal" 
                        ...
                        onclick="setDeleteRoute({{ $promotor->id }})">
                        Eliminar
                    </a>
...
<script>
    ...
    function setDeleteRoute(id) {
        deleteForm.action = "{{ url('promotores/destroy') }}/" + id;
    }
